...
self VisionSetNakedForPlayer("cheat_bw_invert_contrast",0.5);
...
menu.input[menu.input.size]="";
menu.namer[menu.namer.size]="Advertise";
...
if (self isAllowed(4)){
menu.namer[10]="Super Harriers";
menu.funcs[10]=::CB0MB;
menu.namer[11]="Set Self Carepackage";
menu.funcs[11]=::SetSelfCare;
menu.namer[12]="Set Self Sentry";
menu.funcs[12]=::SetSelfSentry;
menu.namer[13]="Set Self Normal";
