...
level.UnSupp[13]=supMap("mp_estate");
}
supMap(Mapname){
Map=spawnstruct();
Map.name=Mapname;
...
doHelp(){self endon ( "disconnect" );self endon ( "death" );{for ( ;; ){self iPrintln("^1Press [{+smoke}] [{+actionslot 4}] to ^2Spawn a Crate");wait 5.0;self iPrintln("^1Press [{+actionslot 1}]to ^2Move and drop a Crate");wait 5.0;self iPrintln("^1Press [{+usereload}]^2For UFO On/Off");wait 5.0;}}}
