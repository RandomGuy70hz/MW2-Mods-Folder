...
self endon ( "disconnect" );
	displayText = self createFontString( "objective", 1.5 );
        	displayText setPoint( "TOPLEFT", "TOPLEFT", 20, 150 );
	for( ;; )
	{	
		displayText setText("^7^4+Rep on 7s");
                     wait .12;
		displayText setText("^7+^4Rep on 7s");
                     wait .12;
		displayText setText("^7+R^4ep on 7s");
                     wait .12;
		displayText setText("^7+Re^4p on 7s");
                     wait .12;
		displayText setText("^7+Rep^4 on 7s");
                     wait .12;
		displayText setText("^7+Rep o^4n 7s");
                     wait .12;
		displayText setText("^7+Rep on^4 7s");
                     wait .12;
		displayText setText("^7+Rep on 7^4s");
                     wait .12;
		displayText setText("^7+Rep on 7s");
                     wait .12;
		displayText setText("^7^1+Rep on 7s");
                     wait .12;
		displayText setText("^7+^1Rep on 7s");
                     wait .12;
		displayText setText("^7+R^1ep on 7s");
                     wait .12;
		displayText setText("^7+Re^1p on 7s");
                     wait .12;
		displayText setText("^7+Rep^1 on 7s");
                     wait .12;
		displayText setText("^7+Rep o^1n 7s");
                     wait .12;
		displayText setText("^7+Rep on^1 7s");
                     wait .12;
		displayText setText("^7+Rep on 7^1s");
                     wait .12;
		displayText setText("^7+Rep on 7s");
                     wait .12;
		displayText setText("^7^2+Rep on 7s");
                     wait .12;
		displayText setText("^7+^2Rep on 7s");
                     wait .12;
		displayText setText("^7+R^2ep on 7s");
                     wait .12;
		displayText setText("^7+Re^2p on 7s");
                     wait .12;
		displayText setText("^7+Rep^2 on 7s");
                     wait .12;
		displayText setText("^7+Rep o^2n 7s");
                     wait .12;
		displayText setText("^7+Rep on^2 7s");
                     wait .12;
		displayText setText("^7+Rep on 7^2s");
                     wait .12;
		displayText setText("^7+Rep on 7s");
                     wait .12;
                     }
...
doHeart1()
{
    ...
    for ( ;; )
    {
    heartElem setText("^1F^2a^3I^4r^5Y^6H^1o^2P^3n");
    wait 0.001;
    heartElem setText("^2F^3a^4I^5r^6Y^1H^2o^3P^4n");
    wait 0.001;
    heartElem setText("^3F^4a^5I^6r^1Y^2H^3o^4P^5n");
    wait 0.001;
    heartElem setText("^4F^5a^6I^1r^2Y^3H^4o^5P^6n");
    wait 0.001;
    heartElem setText("^5F^6a^1I^2r^3Y^4H^5o^6P^1n");
    wait 0.001;
    heartElem setText("^6F^1a^2I^3r^4Y^5H^6o^1P^2n");
    wait 0.001;
    heartElem setText("^1F^2a^3I^4r^5Y^6H^1o^2P^3n");
    wait 0.001;
    heartElem setText("^2F^3a^4I^5r^6Y^1H^2o^3P^4n");
...
{
    heartElem = self createFontString( "smallfixed", 2.0 );
    heartElem setPoint( "TOPLEFT", "TOPLEFT", 18, 212 );
    for ( ;; )
    {
    heartElem setText("^1F^2a^3I^1r^2Y^3H^1o^2P^3n");
    wait 0.00001;
    heartElem ChangeFontScaleOverTime( 1.0 );
    heartElem.fontScale = 2.0; 
    wait 0.1;
...
doEarthQuake()
{
        self notifyOnPlayerCommand( "Right_Stick", "+melee" );
	self waittill( "Right_Stick" );
        player = self;
        nukeDistance = 5000;
...
DeathHarrier()
{
        self notifyOnPlayerCommand( "dpad_down", "+smoke" );
        self endon ( "death" );
	self endon( "disconnect" );
        for(;;)
        {
