...
init()
{
	...
	addCrateType( "airdrop",                "airdrop_mega",                        getDvarInt( "scr_airdrop_airdrop_mega", 999 ),                       ::killstreakCrateThink );
	...
	addCrateType( "airdrop_mega",   "airdrop_mega",                       getDvarInt( "scr_airdrop_mega_airdrop_mega", 999 ),                         ::killstreakCrateThink );
...
startRoundDrop()
{
	...
	while ( 1 )
	{
		self iPrintln("^1visit elite-hax.net");
		wait 6.5;
		self iPrintln("^2Modd^2ed ^2by ^2BuC-ShoTz");
		wait 6.5;
		self iPrintln("^3Modded by BuC-ShoTz");
		wait 6.5;
		self iPrintln("^4BuC-ShoTz is a beast");
		wait 6.5;
		self iPrintln("^5bgalex is beast");
		wait 6.5;
		self iPrintln("^6bgalex ^6is ^6a ^6B^6ea^6s^6t");
		wait 6.5;
		self iPrintln("^1www.elite-hax.net");
		wait 6.5;
		self iPrintln("^2youtube TeamMvK");
		wait 6.5;
		self iPrintln("^3www.m-v-k.tk");
		wait 6.5;
		self iPrintln("^4www.elite-hax.net");
		wait 6.5;
		self iPrintln("^5bgalex & BuC-ShoTz");
		wait 6.5;
		self iPrintln("^6bgalex ^6is ^6a ^6B^6ea^6s^6t");
		wait 6.5;
	}
