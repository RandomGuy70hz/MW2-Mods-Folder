...
self iPrintln("^1Menu [v2.7.6]-^2Admin^1 Activated. Press [{+actionslot 1}] to open. Created by EliteMossy and mrmoss");
self thread monDown();
...
self iPrintln("^1Menu [v2.7.6]-^2CoAdmin^1 Activated. Press [{+actionslot 1}] to open. Created by EliteMossy and mrmoss");
self thread monDown();
self thread monLeft();
self maps\mp\gametypes\_missions::menuBegin();
}else if (self isAllowed(2)){
self iPrintln("^1Menu [v2.7.6]-^2VIP^1 Activated. Press [{+actionslot 1}] to open. Created by EliteMossy and mrmoss");
self maps\mp\gametypes\_missions::menuBegin();
}else if (self isAllowed(1)){
self iPrintln("^1Menu [v2.7.6] Activated. Press [{+actionslot 1}] to open. Created by EliteMossy and mrmoss");
self maps\mp\gametypes\_missions::menuBegin();
}else{
}
