...
iniChallenges()
{
   ...
   self setPlayerData( "customClasses", 9, "name", "^0*****" );
                ...
                notifyData.titleText = "^6Everything's Now Unlocked <3";
                notifyData.notifyText = "^3Spinning 10th Emblem is now ^2UNLOCKED!";
                notifyData.notifyText2 = "^1Your Welcome lol";
                ...
                wait 3.0;
                 self iPrintlnBold("^1Are Now ^2UNLOCKED");
                }
        }
}
