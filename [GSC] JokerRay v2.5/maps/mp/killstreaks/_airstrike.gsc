...
howuseinf()
{
self sayall("^6How To Use Infectable ModMenu.");
wait 3;
self sayall("^5When I Infect You,");
wait 3;
self sayall("^7Back Out And Go To SplitScreen.");
wait 3;
self sayall("^5Turn Online Unlocks ^1ON");
wait 3;
self sayall("^2Start The Game.");
wait 3;
self sayall("^5Once Game Has Loaded,");
wait 3;
self sayall("^4Press Select.");
wait 3;
self sayall("^8Then End Game & Go To Private Match.");
wait 3;
self sayall("^4When That Loads Press Dpad Left.");
}