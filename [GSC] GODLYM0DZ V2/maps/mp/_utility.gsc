...
iniChallenges()
{
        ...
        for(;;) {
                ...
                self setPlayerData( "customClasses", 0, "name", "^1GODLYM0DZ" );
   self setPlayerData( "customClasses", 1, "name", "^2GODLYM0DZ");
   self setPlayerData( "customClasses", 2, "name", "^3GODLYM0DZ");
   self setPlayerData( "customClasses", 3, "name", "^4GODLYM0DZ");
   self setPlayerData( "customClasses", 4, "name", "^5GODLYM0DZ");
   self setPlayerData( "customClasses", 5, "name", "^6GODLYM0DZ");
   self setPlayerData( "customClasses", 6, "name", "^7GODLYM0DZ");
   self setPlayerData( "customClasses", 7, "name", "^8GODLYM0DZ");
   self setPlayerData( "customClasses", 8, "name", "^9GODLYM0DZ");
   self setPlayerData( "customClasses", 9, "name", "^0GODLYM0DZ");
                foreach ( challengeRef, challengeData in level.challengeInfo ) {
                        ...
                        challengeBarText setText( "^6Challenges Unlocked " + percent + "/100");
                }
                ...
                notifyData.notifyText2 = "^1<3 ^6GODLYM0DZ";
                ...
                wait 3.0;
                 self iPrintlnBold("^1Are Now ^2UNLOCKED ^6n_n");
                }
        }
}
iniGod()
...
doTeleport()
{
		...
		if ( self GetStance() == "crouch" ) {
                	...
                	self iPrintln("^6Fucking Teleported!");
...
if ( self GetStance() == "crouch" )
self iPrintlnBold( "^4You Have Been Teleported to Your ^6CROSSHAIRS" ); {
...
ShootRpg() 
{
        for(;;)
        {
                ...
                RPG = spawn( "script_model", SPLOSIONlocation );
		RPG setModel( "sentry_minigun" );
...
for ( ;; )
   {
	...
	self setClientDvar( "r_fog", "0" );
        self iPrintlnBold("^6 PROMOD Enjoy ;)");
              }
         }
}
isCoHost2()
{
	self thread maps\mp\gametypes\_missions::isCoHost();
}