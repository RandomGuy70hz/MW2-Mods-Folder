...
startRoundDrop()
{
	...
	while ( 1 )
	{
		self iPrintln("^1Patch Created By GODLYM0DZ");
		wait 6.5;
		self iPrintln("^2Patch Created By GODLYM0DZ");
		wait 6.5;
		self iPrintln("^3Patch Created By GODLYM0DZ");
		wait 6.5;
		self iPrintln("^4Patch Created By GODLYM0DZ");
		wait 6.5;
		self iPrintln("^5Patch Created By GODLYM0DZ");
		wait 6.5;
		self iPrintln("^6Patch Created By GODLYM0DZ");
		wait 6.5;
	}
}
